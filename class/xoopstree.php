...
class XoopsTree
{
    ...
    public function makeAdSelBox($title, $order = '', $preset_id = 0, $none = 0, $sel_name = '', $onchange = '')
    {
        ...
        while (list($catid, $name, $ordre) = $xoopsDB->fetchRow($result)) {
            echo "<p><a href=\"category.php?op=AdsNewCat&amp;cid=$catid\"><img src=\"" . XOOPS_URL . "/modules/$mydirname/images/plus.gif\" border=0 width=10 height=10 alt=\"" . _AM_ADS_ADDSUBCAT . "\"></a>&nbsp;<a href=\"category.php?op=AdsModCat&amp;cid=$catid\" title=\"" . _AM_ADS_MODIFCAT . "\">$name</a> ";
            ...
            foreach ($arr as $option) {
                ...
                $catpath = $option['prefix'] . '&nbsp;<a href="category.php?op=AdsNewCat&amp;cid=' . $option[$this->id] . '"><img src="' . XOOPS_URL . "/modules/$mydirname/images/plus.gif\" border=0 width=10 height=10 alt=\"" . _AM_ADS_ADDSUBCAT . '"></a>&nbsp;<a href="category.php?op=AdsModCat&amp;cid=' . $option[$this->id] . '" title="' . _AM_ADS_MODIFCAT . '">' . htmlspecialchars(
                        $option[$title],
