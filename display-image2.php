...
$result = $xoopsDB->query('select photo2 FROM ' . $xoopsDB->prefix('ads_listing') . " WHERE lid = '$lid'");
$recordexist = $xoopsDB->getRowsNum($result);

if ($recordexist) {
    [$photo2] = $xoopsDB->fetchRow($result);

    echo "<br><br><center><img src=\"photo2/$photo2\" border=0></center>";
}
