...
$result = $xoopsDB->query('select photo3 FROM ' . $xoopsDB->prefix('ads_listing') . " WHERE lid = '$lid'");
$recordexist = $xoopsDB->getRowsNum($result);

if ($recordexist) {
    [$photo3] = $xoopsDB->fetchRow($result);

    echo "<br><br><center><img src=\"photo3/$photo3\" border=0></center>";
}
